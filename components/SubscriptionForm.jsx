...
export default function SubscriptionForm(props) {
    ...
    function handleFormSubmit(e) {
        e.preventDefault()
         // prevents the random behavior of reloading the webpage
        ...
        <section>
            ...
            <form onSubmit={handleFormSubmit}>
                <label>
                    ...
                    type="text" name="name" placeholder="e.g. Netflix, Spotify, AWS Hosting" required />
                </label>

                <label>
                    <span>Category</span>
                    <select value={formData.category} onChange={handleChangeInput}
                    name="category">
